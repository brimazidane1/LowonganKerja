...
Public Class DaftarLamaran
    ...
    Private Function GetData() As DataTable
        Dim constr As String = "Data Source=.\SQLEXPRESS; Integrated Security=True;AttachDbFilename=D:\DATA KAMPUS\SEMESTER 5\PWEB 2 [PRAKTIKUM]\ProyekKetenagakerjaan\ProyekKetenagakerjaan\App_Data\SistemKetenagakerjaan.mdf;User Instance=True"
