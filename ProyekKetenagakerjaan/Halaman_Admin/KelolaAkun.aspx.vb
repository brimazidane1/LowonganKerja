...
Public Class KelolaAkun
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        koneksi = New SqlConnection("Data Source=.\SQLEXPRESS; Integrated Security=True;AttachDbFilename=D:\DATA KAMPUS\SEMESTER 5\PWEB 2 [PRAKTIKUM]\ProyekKetenagakerjaan\ProyekKetenagakerjaan\App_Data\SistemKetenagakerjaan.mdf;User Instance=True")
        Try
